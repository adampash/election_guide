(defproject election_guide "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "election_guide.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main election-guide.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "election-guide.core/on-figwheel-reload"}

                :compiler {:main election-guide.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/election_guide.js"
                          ...
                          {:test
                           {:source-paths ["src/cljs" "test/cljs"]
                            ...
                            {:output-to "resources/public/js/compiled/testable.js"
                             :main election-guide.test-runner
                             :optimizations :none}}}}}
